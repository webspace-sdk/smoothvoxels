...
class Simplifier {
  ...
  static simplify(model, buffers) {
    ...
    for (
      let i = voxelXZYFaceIndices.length - model.faceCount,
        l = voxelXZYFaceIndices.length;
      i < l;
      i++
    ) {
    ...
    for (
      let i = voxelXYZFaceIndices.length - model.faceCount,
        l = voxelXYZFaceIndices.length;
      i < l;
      i++
    ) {
    ...
    for (
      let i = voxelYZXFaceIndices.length - model.faceCount,
        l = voxelYZXFaceIndices.length;
      i < l;
      i++
    ) {
  ...
  static _mergeFaces(
    ...
    if (
      ...
      (material.simplify === true ||
        (material.simplify === null && model.simplify === true)) &&
      ...
      const normalsEqual =
        this._normalEquals(
          ...
          faceVertNormal0Y,
          faceVertNormal0Z,
          lastFaceVertNormal0X,
          lastFaceVertNormal0Y,
          lastFaceVertNormal0Z
        ) &&
        this._normalEquals(
          faceVertNormal1X,
          faceVertNormal1Y,
          faceVertNormal1Z,
          lastFaceVertNormal1X,
          lastFaceVertNormal1Y,
          lastFaceVertNormal1Z
        ) &&
        this._normalEquals(
          faceVertNormal2X,
          faceVertNormal2Y,
          faceVertNormal2Z,
          lastFaceVertNormal2X,
          lastFaceVertNormal2Y,
          lastFaceVertNormal2Z
        ) &&
        this._normalEquals(
          faceVertNormal3X,
          faceVertNormal3Y,
          faceVertNormal3Z,
          lastFaceVertNormal3X,
          lastFaceVertNormal3Y,
          lastFaceVertNormal3Z
        );
      ...
      const colorsEqual =
        faceVertColor0R === lastFaceVertColor0R &&
        faceVertColor0G === lastFaceVertColor0G &&
        faceVertColor0B === lastFaceVertColor0B &&
        faceVertColor1R === lastFaceVertColor1R &&
        faceVertColor1G === lastFaceVertColor1G &&
        faceVertColor1B === lastFaceVertColor1B &&
        faceVertColor2R === lastFaceVertColor2R &&
        faceVertColor2G === lastFaceVertColor2G &&
        faceVertColor2B === lastFaceVertColor2B &&
        faceVertColor3R === lastFaceVertColor3R &&
        faceVertColor3G === lastFaceVertColor3G &&
        faceVertColor3B === lastFaceVertColor3B;
      ...
      const positionsEqual =
        Math.abs(
          axis1Arr[lastFaceVertIndexV1] -
            (1 - ratio) * axis1Arr[faceVertIndexV1] -
            ratio * axis1Arr[lastFaceVertIndexV0]
        ) <= EPS &&
        Math.abs(
          axis2Arr[lastFaceVertIndexV1] -
            (1 - ratio) * axis2Arr[faceVertIndexV1] -
            ratio * axis2Arr[lastFaceVertIndexV0]
        ) <= EPS &&
        Math.abs(
          axis3Arr[lastFaceVertIndexV1] -
            (1 - ratio) * axis3Arr[faceVertIndexV1] -
            ratio * axis3Arr[lastFaceVertIndexV0]
        ) <= EPS &&
        Math.abs(
          axis1Arr[lastFaceVertIndexV2] -
            (1 - ratio) * axis1Arr[faceVertIndexV2] -
            ratio * axis1Arr[lastFaceVertIndexV3]
        ) <= EPS &&
        Math.abs(
          axis2Arr[lastFaceVertIndexV2] -
            (1 - ratio) * axis2Arr[faceVertIndexV2] -
            ratio * axis2Arr[lastFaceVertIndexV3]
        ) <= EPS &&
        Math.abs(
          axis3Arr[lastFaceVertIndexV2] -
            (1 - ratio) * axis3Arr[faceVertIndexV2] -
            ratio * axis3Arr[lastFaceVertIndexV3]
        ) <= EPS;
      ...
      faceVertFlatNormalX[lastFaceOffset + v1] =
        faceVertFlatNormalX[faceOffset + v1];
      faceVertFlatNormalY[lastFaceOffset + v1] =
        faceVertFlatNormalY[faceOffset + v1];
      faceVertFlatNormalZ[lastFaceOffset + v1] =
        faceVertFlatNormalZ[faceOffset + v1];
      faceVertFlatNormalX[lastFaceOffset + v2] =
        faceVertFlatNormalX[faceOffset + v2];
      faceVertFlatNormalY[lastFaceOffset + v2] =
        faceVertFlatNormalY[faceOffset + v2];
      faceVertFlatNormalZ[lastFaceOffset + v2] =
        faceVertFlatNormalZ[faceOffset + v2];

      faceVertSmoothNormalX[lastFaceOffset + v1] =
        faceVertSmoothNormalX[faceOffset + v1];
      faceVertSmoothNormalY[lastFaceOffset + v1] =
        faceVertSmoothNormalY[faceOffset + v1];
      faceVertSmoothNormalZ[lastFaceOffset + v1] =
        faceVertSmoothNormalZ[faceOffset + v1];
      faceVertSmoothNormalX[lastFaceOffset + v2] =
        faceVertSmoothNormalX[faceOffset + v2];
      faceVertSmoothNormalY[lastFaceOffset + v2] =
        faceVertSmoothNormalY[faceOffset + v2];
      faceVertSmoothNormalZ[lastFaceOffset + v2] =
        faceVertSmoothNormalZ[faceOffset + v2];

      faceVertBothNormalX[lastFaceOffset + v1] =
        faceVertBothNormalX[faceOffset + v1];
      faceVertBothNormalY[lastFaceOffset + v1] =
        faceVertBothNormalY[faceOffset + v1];
      faceVertBothNormalZ[lastFaceOffset + v1] =
        faceVertBothNormalZ[faceOffset + v1];
      faceVertBothNormalX[lastFaceOffset + v2] =
        faceVertBothNormalX[faceOffset + v2];
      faceVertBothNormalY[lastFaceOffset + v2] =
        faceVertBothNormalY[faceOffset + v2];
      faceVertBothNormalZ[lastFaceOffset + v2] =
        faceVertBothNormalZ[faceOffset + v2];
  ...
  static _normalEquals(n1x, n1y, n1z, n2x, n2y, n2z) {
    return (
      Math.abs(n1x - n2x) < 0.01 && // Allow for minimal differences
